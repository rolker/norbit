...
namespace norbit_types {
  ...
  void WaterColumnData::setBits(std::shared_ptr<norbit_interfaces::msg::CommonHeader> comm_hdr, std::shared_ptr<char> bits){
    bits_ = bits;
    comm_hdr_ = comm_hdr;
    water_column_header_ = reinterpret_cast<norbit_interfaces::msg::WaterColumnHeader*>(
          bits_.get() );
    ...
    auto pixel_data_offset = sizeof(norbit_interfaces::msg::WaterColumnHeader);
  ...
  norbit_interfaces::msg::WaterColumnStamped WaterColumnData::getRosMsg(std::string frame_id)const{
    ...
    norbit_interfaces::msg::WaterColumnStamped outMsg;
    rclcpp::Time stamp(water_column_header_->time*1000000000);
    ...
    auto pixel_data_size = m * n * dataSize();
